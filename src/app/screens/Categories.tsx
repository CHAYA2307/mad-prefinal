...
import { Camera, Sparkles, Palette, ChevronRight, User } from "lucide-react";
...
export default function Categories() {
  ...
  const handleCategoryClick = (categoryId: string, subcategory: string) => {
    navigate(`/creators/${categoryId}/${encodeURIComponent(subcategory)}`);
  };
      ...
      <div className="bg-blue-600 text-white p-6 pb-8">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-3">
            ...
            <h1 className="text-xl">Clip Crew</h1>
          </div>
          <button
        ...
        <h2 className="text-2xl mb-1">Discover Creators</h2>
